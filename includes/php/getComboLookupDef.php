<?php
/*
 *  getComboLookupDef.php
 *  Version for HR Stipends (and hr_stipends_prototype)
 *  Returns the Lookup Definition list in JSON suitable
...
$sql  = "SELECT LOOKUP_DEF_GU, LOOKUP_DEF_CODE FROM bsd.LOOKUP_TABLE_DEF";
...
if( $db->Query($sql) )
{
    ...
    {
        $data[] = array(
        'id' => $row['LOOKUP_DEF_GU'],
        'value' => $row['LOOKUP_DEF_CODE']);
    }
}
